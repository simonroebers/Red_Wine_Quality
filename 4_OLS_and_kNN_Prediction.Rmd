---
title: '4 OLS and kNN Prediction'
output:
  github_document:
    toc: true
    toc_depth: 2
...
- Linear regression model does smaller errors at predicting whine quality
- K-nearest neighbors can explain more variation of the dependent variable